...
(
    ...
    table_conts_nm     VARCHAR(50) NOT NULL            COMMENT '테이블 컨텐츠명',     
    ...
    cty_smry_type      CHAR(1).                        COMMENT '시군구레벨집계유형',
    web_use_yn         CHAR(1) NOT NULL                COMMENT '웹사용여부',
    cty_ihrt_yn        CHAR(1) NOT NULL                COMMENT '구지표상위시상속여부',    
